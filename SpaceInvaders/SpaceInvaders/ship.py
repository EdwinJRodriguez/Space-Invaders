...
class Ship(Sprite):
    ...
    def __init__(self, game):
        ...
        self.lives = pg.image.load('images/ship.png').convert_alpha()
        self.lives_x_start_pos = self.settings.screen_width - (self.lives.get_size()[0] * 2 + 20)
...
# #       game_over if the ships == 0
    ...
    def draw_lives(self):
        ...
        for live in range(self.ships_left -1 ):
            x = self.lives_x_start_pos + (live * self.lives.get_size()[0] -1000)
            self.screen.blit(self.image, (x,15))
